...
namespace DigitalRuby.Core.Services.Caching.Serialization;
...
public sealed class ManagedCache : AsyncPolicy, IManagedCache, IKeyStrategy, IDisposable, IHostedService
{
	...
	public ManagedCache(IMemoryCache memoryCache, IDistributedCache distributedCache, ILogger<ManagedCache> logger)
	{
