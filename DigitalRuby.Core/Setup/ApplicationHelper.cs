using DigitalRuby.Core.Mvc;
using DigitalRuby.Core.Services.Authentication;
...
/// <summary>
/// Assists with setting up a .NET server application
/// </summary>
public static class ApplicationHelper
{
	...
	public static WebApplication CreateWebApplication(string[] args,
		Action<IServiceCollection, IConfiguration>? postSetup = null)
	{
