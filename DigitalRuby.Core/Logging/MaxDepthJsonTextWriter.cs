...
public class MaxDepthJsonTextWriter : JsonTextWriter
{
	...
	public MaxDepthJsonTextWriter(System.IO.TextWriter writer, JsonSerializerSettings settings)
		: base(writer)
	{
	...
	public MaxDepthJsonTextWriter(System.IO.TextWriter writer, int? maxDepth)
		: base(writer)
	{
