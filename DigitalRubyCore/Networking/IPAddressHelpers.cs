...
namespace FeatureFlags.Core.Networking;
...
public static class IPAddressHelpers
{
	...
	/// <param name="allowForwarded">Whether to allow x-forwarded-for or x-real-ip header check, default is to allow forwarded headers</param>
